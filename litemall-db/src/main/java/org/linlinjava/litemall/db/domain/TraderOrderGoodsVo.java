...
public class TraderOrderGoodsVo {
    ...
    private String parentOrderGoodsName;
    private String[] parentOrderGoodsSpecifications;
    private String rootOrderGoodsName;
    private String[] rootOrderGoodsSpecifications;
