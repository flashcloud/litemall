...
public class LitemallUser {
    ...
    public boolean isMemberOrderIdExists(Integer memberOrderId) {
        if (memberOrderIds == null) {
            return false;
        }
        //return (Arrays.asList(memberOrderIds).contains(memberOrderId));
        for (Integer memberOrderIdInArray : memberOrderIds) {
            if (memberOrderIdInArray.equals(memberOrderId)) {
                return true;
            }
        }
        return false;
