...
public class LitemallUser {
    ...
    public boolean equals(Object that) {
        ...
        return (this.getId() == null ? other.getId() == null : this.getId().equals(other.getId()))
            ...
            && (this.getTraderIds() == null ? other.getTraderIds() == null :  Arrays.equals(this.getTraderIds(), other.getTraderIds()));
    }
    ...
    public int hashCode() {
        ...
        result = prime * result + ((getTraderIds() == null) ? 0 : Arrays.hashCode(getTraderIds()));
        return result;
    }
